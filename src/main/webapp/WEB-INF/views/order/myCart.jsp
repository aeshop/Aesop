            ...
            <div id="n-order-container">
                ...
                <div id="n-membership-benefit-wrapper">
                    <div class="n-infomation">
                        ...
                        <div class="n-membership">
                            <span id="n-membership-id">${sessionScope.loginMember.memberName}</span>님은, [<span id="n-membership-rank">${sessionScope.loginMember.memberGradeName}</span>] 회원이십니다. <br>구매금액의
                ...
                <div id="n-cart-info">
                                    ...
                                    <c:forEach items="${orderList}" var="index" varStatus="vs">
                                        <%--DB에서 정보 받아와서 화면에 뿌리기 hidden으로 주문번호 checkbox 앞에 숨겨둠 parentNode firstChild로 접근가능  --%>
                                            <tr>
                                                ...
                                                <td class="proPrice" width="100px;">
                                                    <fmt:formatNumber value="${price}" maxFractionDigits="3" />원</td>
				    ...
				    <a onclick="amountDown(this)"><img src="${contextPath}/resources/images/order/btn_quantity_down.gif"alt="수량Down버튼"></a>
                                                ...
                                                <td class="n-cart-btns">
                                                    <a onclick="doOrder()"><img src="${contextPath}/resources/images/order/btn_order_p.png" alt="주문하기버튼img"></a>
                                                    <a onclick="deleteOrder()"><img src="${contextPath}/resources/images/order/btn_delete2.gif" alt="삭제버튼img"></a>
                                                </td>
                                            </tr>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="5" style="text-align:left;">[기본배송]</td>
                                <td colspan="3">상품구매금액 <span class="n-proCal"></span>+ 배송비 <span class="n-shipCal"></span> = 합계 : <span class="n-sumCal"></span>원</td>
                            </tr>
                    ...
                    <div class="n-cart-ctl-btn">
                        <span>선택상품을</span>
                        <a onclick="deleteSelectedOrder()"><img src="${contextPath}/resources/images/order/btn_delete2.gif" alt="삭제하기버튼img"></a>
                        <p>
