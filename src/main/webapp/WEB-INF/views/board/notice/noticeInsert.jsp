	...
	<div class="container my-5">
		...
		<form action="insert" method="post" role="form"
			...
			<div class="form-inline mb-2" >
				<label class="input-group-addon mr-3 insert-label" style="padding-bottom: 19px;">제목　</label> <input
					placeholder=" 제목을 입력해주세요." type="text" class="fgmkt"
					id="boardTitle" name="boardTitle" size="40">
					<label class="input-group-addon mr-3 insert-label" style="padding-bottom: 19px;">　　평점　</label>
					<select name="star" class="tSBKF">
