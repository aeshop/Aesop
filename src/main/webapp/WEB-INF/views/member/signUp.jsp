...
<div class="signup_wrap">
    <form class="signup_form" method="post" action="${contextPath}/member/signup" onsubmit="return Validate()">
      <h2>회원가입</h2>
      <div class="join_step">
      ...
      <div class="input_wrap">
        ...
        <div class="signup_input">
          <input id="pwd2" name="pwd2" placeholder="비밀번호 확인" type="password" required> <span id="checkPwd2"
      ...
      <div class="input_wrap2">
        ...
        <div class="signup_input">
          <input id="memberBirthday" name="memberBirthday" placeholder="생년월일을 8자리 입력해주세요." type="number" required>
        </div>
        <div class="signup_input" style="border: 1px solid rgb(201 201 201)">
          <select id="phone1" name="phone" style="width: 20%; font-size: 19px; border: none;" required>
            ...
            <input id="phone2" name="phone" maxlength="4" type="text" style="width: 30%; border: none;" required>
            -
            <input id="phone3" name="phone" maxlength="4" type="text" style="width: 30%; border: none;" required>
